		...
		return(
			<div className='filter-box'>
		       ...
		       <input className="input-control" type="text" name='filterValue' value={this.state.filterValue} onChange={this.handleChange} />
				 ...
				 <div className="form-group">
		      	<button className="sdk-btn button-control" onClick={() => {this.addFilter()}} >Add Filter</button>
		      	<button className="sdk-btn button-control" onClick={() => {this.reset()}} >Reset</button>
					</div>
				</div>
			</div>
		)
