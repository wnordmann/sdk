  ...
  getLayerNode(lyr) {
    if (lyr.get('hideFromLayerList') !== true) {
      if (lyr instanceof ol.layer.Group) {
        ...
        return (
          <LayerListItem map={this.props.map} showOpacity={this.props.showOpacity} showDownload={this.props.showDownload} allowReordering={this.props.allowReordering} showZoomTo={this.props.showZoomTo} key={lyr.get('title')} layer={lyr} children={children} title={lyr.get('title')} />
        );
      } else {
        return (
          <LayerListItem map={this.props.map} showOpacity={this.props.showOpacity} showDownload={this.props.showDownload} allowReordering={this.props.allowReordering} showZoomTo={this.props.showZoomTo} key={lyr.get('title')} layer={lyr} title={lyr.get('title')} />
        );
      }
    }
  }
