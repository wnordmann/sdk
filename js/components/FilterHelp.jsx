  ...
  render() {
    ...
    return (
      <span className='filter-help'>
        ...
        <Popover open={this.state.help} onRequestClose={this._onToggleHelp.bind(this)} style={popStyle} anchorEl={this.helpElement} anchorOrigin={{'vertical':'middle','horizontal':'left'}}>
          <p>
