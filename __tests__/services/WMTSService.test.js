...
describe('WMTSService', function() {
  ...
  it('parses response correctly and can create layer', function() {
    ...
    assert.equal(layer.getSource() instanceof ol.source.WMTS, true);
  });
