...
describe('SLDService', function() {
  ...
  it('roundtrips PointSymbolizer ExternalGraphic', function() {
    ...
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Default Styler', styleInfo: info}), 'Point', info.featureTypeStyles);
  ...
  it('roundtrips SLD Cook Book: Simple Point', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Simple Point', styleInfo: info}), 'Point', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Simple point with stroke', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Simple point with stroke', styleInfo: info}), 'Point', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Rotated square', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Rotated square', styleInfo: info}), 'Point', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Transparent triangle', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Transparent triangle', styleInfo: info}), 'Point', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Point as graphic', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Point as graphic', styleInfo: info}), 'Point', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Point with default label', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Point with default label', styleInfo: info}), 'Point', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Point with styled label', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Point with styled label', styleInfo: info}), 'Point', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Point with rotated label', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Point with rotated label', styleInfo: info}), 'Point', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Attribute-based point', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Attribute-based point', styleInfo: info}), 'Point', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Zoom-based point', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Zoom-based point', styleInfo: info}), 'Point', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Simple Line', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Simple Line', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Line with border', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Line with border', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Dashed line', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Dashed line', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Railroad (hatching)', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Railroad (hatching)', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Dash/Space line', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Dash - symbol and space', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Dash/Symbol line', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Dash - symbol', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Line with default label', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Line with default label', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Label following line', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Label following line', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Optimized label placement', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Optimized label placement', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Optimized and styled label', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Optimized and styled label', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Attribute-based line', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Attribute-based line', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Zoom-based line', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Zoom-based line', styleInfo: info}), 'LineString', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Simple polygon', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Simple polygon', styleInfo: info}), 'Polygon', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Simple polygon with stroke', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Simple polygon with stroke', styleInfo: info}), 'Polygon', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Transparent polygon', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Transparent polygon', styleInfo: info}), 'Polygon', info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Offset line', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Dashed line', styleInfo: info}), undefined, info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Graphic fill', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Graphic fill', styleInfo: info}), undefined, info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Hatching fill', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Hatching fill', styleInfo: info}), undefined, info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Polygon with default label', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Polygon with default label', styleInfo: info}), undefined, info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Label halo', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Label halo', styleInfo: info}), undefined, info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Polygon with styled label', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Polygon with styled label', styleInfo: info}), undefined, info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips GeoServer SLD Cook Book: Attribute-based polygon', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Attribute-based polygon', styleInfo: info}), undefined, info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });

  it('roundtrips GeoServer SLD Cook Book: Zoom-based polygon', function() {
    var sld = '<sld:StyledLayerDescriptor xmlns:sld="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" version="1.0.0"><sld:NamedLayer><sld:Name>Zoom-based polygon</sld:Name><sld:UserStyle><sld:Title>SLD Cook Book: Zoom-based polygon</sld:Title><sld:FeatureTypeStyle><sld:Rule><sld:Name>Large</sld:Name><sld:MaxScaleDenominator>100000000</sld:MaxScaleDenominator><sld:PolygonSymbolizer><sld:Fill><sld:CssParameter name="fill">#0000CC</sld:CssParameter></sld:Fill><sld:Stroke><sld:CssParameter name="stroke">#000000</sld:CssParameter><sld:CssParameter name="stroke-width">7</sld:CssParameter></sld:Stroke></sld:PolygonSymbolizer><sld:TextSymbolizer><sld:Label><ogc:PropertyName>name</ogc:PropertyName></sld:Label><sld:Font><sld:CssParameter name="font-family">Arial</sld:CssParameter><sld:CssParameter name="font-size">14</sld:CssParameter><sld:CssParameter name="font-style">normal</sld:CssParameter><sld:CssParameter name="font-weight">bold</sld:CssParameter></sld:Font><sld:LabelPlacement><sld:PointPlacement><sld:AnchorPoint><sld:AnchorPointX>0.5</sld:AnchorPointX><sld:AnchorPointY>0.5</sld:AnchorPointY></sld:AnchorPoint></sld:PointPlacement></sld:LabelPlacement><sld:Fill><sld:CssParameter name="fill">#FFFFFF</sld:CssParameter></sld:Fill></sld:TextSymbolizer></sld:Rule><sld:Rule><sld:Name>Medium</sld:Name><sld:MinScaleDenominator>100000000</sld:MinScaleDenominator><sld:MaxScaleDenominator>200000000</sld:MaxScaleDenominator><sld:PolygonSymbolizer><sld:Fill><sld:CssParameter name="fill">#0000CC</sld:CssParameter></sld:Fill><sld:Stroke><sld:CssParameter name="stroke">#000000</sld:CssParameter><sld:CssParameter name="stroke-width">4</sld:CssParameter></sld:Stroke></sld:PolygonSymbolizer></sld:Rule><sld:Rule><sld:Name>Small</sld:Name><sld:MinScaleDenominator>200000000</sld:MinScaleDenominator><sld:PolygonSymbolizer><sld:Fill><sld:CssParameter name="fill">#0000CC</sld:CssParameter></sld:Fill><sld:Stroke><sld:CssParameter name="stroke">#000000</sld:CssParameter><sld:CssParameter name="stroke-width">1</sld:CssParameter></sld:Stroke></sld:PolygonSymbolizer></sld:Rule></sld:FeatureTypeStyle></sld:UserStyle></sld:NamedLayer></sld:StyledLayerDescriptor>';
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'Zoom-based polygon', styleInfo: info}), undefined, info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('roundtrips vendor options in TextSymbolizer', function() {
    ...
    var info = SLDService.parse(sld);
    var sld2 = SLDService.createSLD(new ol.layer.Layer({name: 'ne:populated_places', styleInfo: info}), undefined, info.featureTypeStyles);
    expect(sld).xml.to.equal(sld2);
  });
  ...
  it('can parse PropertyIsBetween', function() {
    ...
    assert.equal(expression[1][0], '>=');
    assert.equal(expression[1][1], 'PERSONS');
    assert.equal(expression[1][2], '2000000');
    assert.equal(expression[2][0], '<=');
    assert.equal(expression[2][1], 'PERSONS');
    assert.equal(expression[2][2], '4000000');
  });

  it('can parse PropertyIsNotEqualTo', function() {
    var sld = '<sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" version="1.0.0"><sld:NamedLayer><sld:Name>population</sld:Name><sld:UserStyle><sld:Name>population</sld:Name><sld:Title>Population in the United States</sld:Title><sld:FeatureTypeStyle><sld:Name>name</sld:Name><sld:Rule><sld:Name>NE 2000000</sld:Name><sld:Title>2M - 4M</sld:Title><ogc:Filter><ogc:PropertyIsNotEqualTo><ogc:PropertyName>PERSONS</ogc:PropertyName><ogc:Literal>2000000</ogc:Literal></ogc:PropertyIsNotEqualTo></ogc:Filter><sld:PolygonSymbolizer><sld:Fill><sld:CssParameter name="fill">#FF4D4D</sld:CssParameter><sld:CssParameter name="fill-opacity">0.7</sld:CssParameter></sld:Fill></sld:PolygonSymbolizer></sld:Rule></sld:FeatureTypeStyle></sld:UserStyle></sld:NamedLayer></sld:StyledLayerDescriptor>';
    var info = SLDService.parse(sld);
    var expression = info.featureTypeStyles[0].rules[0].expression;
    assert.equal(expression[0], '!=');
    assert.equal(expression[1], 'PERSONS');
    assert.equal(expression[2], '2000000');
  });
