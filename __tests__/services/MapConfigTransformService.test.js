...
describe('MapConfigTransfrormService', function() {
  ...
  it('transforms correctly', function() {
    ...
    var expected = {'layers':[{'type':'Group','properties':{'title':'Base Maps','type':'base-group'},'children':[{'properties':{'isRemovable':true,'visible':true,'title':'OpenStreetMap','id':'mapnik','name':'mapnik','type':'base'},'type':'Tile','source':{'type':'OSM'}}]},{'properties':{'isRemovable':true,'visible':true,'title':'States of the USA','id':'usa:states','name':'usa:states','isSelectable':true,'isWFST':true,'popupInfo':'#AllAttributes','styleName':'states','legendUrl':'http://localhost:8080/geoserver/wms?request=GetLegendGraphic&format=image%2Fpng&width=20&height=20&layer=usa%3Astates','EX_GeographicBoundingBox':[-179.23023299999997,17.831509000000036,-65.16882499999997,71.437769]},'type':'Tile','source':{'type':'TileWMS','properties':{'params':{'LAYERS':'usa:states','STYLES':'','TILED':'TRUE','FORMAT':'image/png','TRANSPARENT':true},'url':'/geoserver/ows'}}}],'view':{'center':[0,0],'projection':'EPSG:102113','zoom':3}};
