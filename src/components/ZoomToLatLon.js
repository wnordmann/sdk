  ...
  render() {
    ...
    return (
      <span style={this.props.style}>
        ...
        <Dialog actions={actions} open={this.state.openDialog ? this.state.openDialog : false} autoScrollBodyContent={true} onRequestClose={this.closeDialog.bind(this)} modal={true} title={formatMessage(messages.modaltitle)}>
          {body}
        </Dialog>
      </span>
    );
